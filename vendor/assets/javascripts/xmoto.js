...
(function() {
  ...
  Constants = (function() {
    ...
    if (url.param('body_density')) {
      Constants.body_density = parseFloat(url.param('body_density'));
    }

    if (url.param('left_wheel_density')) {
      Constants.left_wheel_density = parseFloat(url.param('left_wheel_density'));
    }

    if (url.param('right_wheel_density')) {
      Constants.right_wheel_density = parseFloat(url.param('right_wheel_density'));
    }

    if (url.param('left_axle_density')) {
      Constants.left_axle_density = parseFloat(url.param('left_axle_density'));
    }

    if (url.param('right_axle_density')) {
      Constants.right_axle_density = parseFloat(url.param('right_axle_density'));
    }

    if (url.param('head_density')) {
      Constants.head_density = parseFloat(url.param('head_density'));
    }

    if (url.param('torso_density')) {
      Constants.torso_density = parseFloat(url.param('torso_density'));
    }

    if (url.param('lower_leg_density')) {
      Constants.lower_leg_density = parseFloat(url.param('lower_leg_density'));
    }

    if (url.param('upper_leg_density')) {
      Constants.upper_leg_density = parseFloat(url.param('upper_leg_density'));
    }

    if (url.param('lower_arm_density')) {
      Constants.lower_arm_density = parseFloat(url.param('lower_arm_density'));
    }

    if (url.param('upper_arm_density')) {
      Constants.upper_arm_density = parseFloat(url.param('upper_arm_density'));
    }
